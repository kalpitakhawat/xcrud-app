      ...
      <div class="row">
            <div class="col">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="client_matter_name" onkeypress="document.theform.client_matter.value = this.value"  name="clientmattername" v-model="clientname" >
            ...
            <div class="col">
                ...
                <div class="form-group">
                    ...
                    <input type="name" class="form-control" id="client_matter_number" aria-describedby="emailHelp" placeholder="Enter Client Number" v-model="client_number" >
                </div>
...
<div class="form-group">
  ...
  <input type="name" class="form-control" id="pepper_finance" aria-describedby="emailHelp" placeholder="Select Pepper Finance" v-model="pepper_finance" >
...
<div class="form-group">
  ...
  <input  id="datepicker" class="form-control" aria-describedby="emailHelp" v-model="closing_date" >
</div>
...
<h4>Client Local counsel (U.S. domestic): </h4>
  <input type="name" class="form-control" name="Firm" id="client_local_counsel_us" aria-describedby="" placeholder="Enter Firm Name" v-model="client_us" >
...
<input type="name" class="form-control" name="Firm" id="opposing_local_counsel_foreign" aria-describedby="" placeholder="Enter Firm Name" v-model="opposing_foriegn" >
